...
//$id =$_GET['erp_id'];
      // $h = mysql_query(" select e_id, e_name,sp_code,sp_my from pay_spe where sp_my='$dat1  $dat2' group by sp_code ") or die(mysql_error()); 
       $h = mysql_query(" select e_id, e_name,sp_code,sp_mth,sp_yr from pay_spe GROUP BY sp_code") or die(mysql_error()); 
    ...
    ?>
        ...
        <td><br>
		&nbsp;&nbsp;&nbsp;&nbsp; <a  href="viewps.php?erp_id=<?php echo $tr['e_id']; ?>&pi=<?php echo $tr['sp_code'];  ?>" class=" btn-sm">
          <span class="glyphicon glyphicon-file"></span> 
        </a>&nbsp;&nbsp;&nbsp;&nbsp; <a   href="viewps_edit.php?erp_id=<?php echo $tr['e_id']; ?>&pi=<?php echo $tr['sp_code'];  ?>" class=" btn-sm">
