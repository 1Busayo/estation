...
{
  $mngs='Tank name '.$txt1.' already exist';
...
if(empty($txt1) || empty($txt2)|| empty($txt3) ){
	...
	$query = mysql_query(" INSERT INTO e_tank ( `tank_name`, `tank_prod`, `tank_liters`, tank_code) VALUES  ('{$txt1}','{$txt2}','{$txt3}','{$pin}')") or die(mysql_error());
...
<p><span>Tank Name</span><input name="txt1" class="form-control"  data-validation="required"  type="text" style="width:200px;" required>
</p>
	
<p><span>Tank Product</span><select  name="txt2" class="form-control"  data-validation="required"  type="text" style="width:200px;" required>
<option value=""></option>
...
<p><span>Liters</span><input  name="txt3" class="form-control"  data-validation="required"  type="text" style="width:200px;" required>
</p>
...
<table id="example1" class="table table-bordered table-hover">
        ...
        <th width="10%">Tank Name </th>
        <th width="10%">Tank Product</th>
		<th width="10%">Tank Liters</th>
		<th width="10%">Tank Sales</th>
...
$h = mysql_query("Select * FROM e_tank ") or die(mysql_error()); 
        ...
        <tr class="record">
            ...
            <td><br><?php echo $tr['tank_name']; ?></td>
		    <td><br><?php echo $tr['tank_prod']; ?></td>
			<td><br><?php echo $tr['tank_liters']; ?></td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp; <a   href="tan2a.php?tp=<?php echo $tr['tank_code'] ;?>" class=" btn-sm">
          <i class="fa fa-money"></i> 
        </a> 
	
		</td> 
		<td>&nbsp;&nbsp;&nbsp;&nbsp; <a   href="tan3a.php?tp=<?php echo $tr['tank_code'] ;?>" class=" btn-sm">
          <i class="fa fa-plus"></i> 
        </a> 
	
		</td> 
		<td>&nbsp;&nbsp;&nbsp;&nbsp; <a  rel="facebox" href="tank_edit.php?erp_id=<?php echo $tr['tank_id']; ?>&pin=<?php echo $tr['tank_code'];?>" class=" btn-sm">
	...
	</td><td>&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" id="<?php echo $tr['tank_id']; ?>" class="delbutton" title="Click To Delete"><span class="fa fa-trash"></a>
