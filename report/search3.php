...
<li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="../report/sales_rp.php"><i class="fa fa-circle-o"></i> Sales Report</a></li>
...
//$id =$_GET['erp_id'];
       $h = mysql_query(" SELECT c_name , sales_code, date_sales, amount_paid, total_amount, balance_to_pay FROM  cust_pay, customerdetails  WHERE cust_pay.c_id=customerdetails.c_id and amount_paid!=total_amount ORDER BY c_name AND   date_sales BETWEEN '$dat1' AND '$dat2' ;") or die(mysql_error()); 
    ...
    ?>
        ...
        <td><br><?php $pa=$tr['date_sales'];   $dat2 = date('d/m/Y', strtotime($pa)); echo $dat2;?></td>
