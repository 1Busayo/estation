            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tank Sales</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
echo "<Center><p><b>Tank Sales</b></p><b>". $d1 = date('d F Y ', strtotime($a)) ." - ".  $d2 = date('d F Y', strtotime($b))."</b></Center>";


$kool = mysql_query(" Select * FROM tank_stock where date_stock Between '$da' AND '$da2' ") or die(mysql_error()); 
...
$h = mysql_query("Select * FROM tank_stock where date_stock Between '$da' AND '$da2' ") or die(mysql_error()); 
