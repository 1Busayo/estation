            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tank Stock</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
echo "<Center><p><b>Tank Stock</b></p><b>". $d1 = date('d F Y ', strtotime($a)) ." - ".  $d2 = date('d F Y', strtotime($b))."</b></Center>";


$kool = mysql_query(" Select * FROM hist_tank where date_stock Between '$da' AND '$da2' ") or die(mysql_error()); 
...
$h = mysql_query("Select * FROM hist_tank where date_stock Between '$da' AND '$da2' ") or die(mysql_error()); 
...
function fnExcelReport() {
    ...
    if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
        if (window.navigator.msSaveBlob) {
            ...
            navigator.msSaveBlob(blob, 'Tank-sales-'+trandate+'.xls');
        }
    } else {
		//window.open( data_type + ',' + encodeURIComponent(tab_text));
        $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
        $('#test').attr('download', 'Tank-sales-'+trandate+'.xls');
    }
