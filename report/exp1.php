...
header("location: exp2.php?a=".$a.'&b='.$b); 
}
...
<input name="txt1" class="form-control" data-validation="date required" data-validation-format="mm/dd/yyyy" id="datepicker" autocomplete="off"  data-validation-error-msg="Input Date" value="" type="text" style="width:200px;" required/>
	...
	<span>To</span>
<input name="txt1a" class="form-control" data-validation="date required" data-validation-format="mm/dd/yyyy" autocomplete="off"  id="datepicker2" data-validation-error-msg="Input Date"  value="" type="text" style="width:200px;" required/></p></br>
