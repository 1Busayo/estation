...
<li class="treeview">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Debtors
            <small>Debtors Payment</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../home.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Debtors Payment</li>
          </ol>
        </section>
...
//$id =$_GET['erp_id'];
			 $h = mysql_query(" SELECT c_name , sales_code, date_sales, date_paid,amount_paid, total_amount, balance_to_pay FROM  cust_pay, customerdetails  WHERE cust_pay.c_id=customerdetails.c_id and amount_paid!=total_amount ORDER BY c_name ASC") or die(mysql_error()); 
		...
		&nbsp;&nbsp;&nbsp;&nbsp; <a  rel="facebox" href="sales_calc.php?erp_id=<?php echo $tr['c_name']; ?>&code=<?php echo $tr['sales_code'] ;?>" class=" btn">
