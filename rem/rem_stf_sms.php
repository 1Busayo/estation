<?php  include '../include/header.php';?>
 <!-- /.search form -->
       ...
       <ul class="sidebar-menu">
        ...
        <li class="active"><a href="rem_stf.php"><i class="fa fa-circle-o"></i>Staff</a></li>
                <li><a href="rem_cu.php"><i class="fa fa-circle-o"></i> Customers</a></li>
...
<li class="treeview">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Sms
            <small>Sms Reminder to all Staffs</small>
          </h1>
           <ol class="breadcrumb">
            <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="rem_stf.php"><i class="fa fa-bell"></i>Staff Reminder</a></li>
            <li class="active">Staff Reminder Sms</li>
          </ol>
        </section>
