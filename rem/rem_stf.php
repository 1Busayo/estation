        ...
        <section class="content-header">
          <h1>
           ...
           <ol class="breadcrumb">
			...
			<li class="active">Staff Reminder</li>
          </ol>
        </section>
            ...
            <div class="col-xs-10">
              <div class="box">
                ...
                <div class="box-body">
				 ...
				 <tr>
<td> <a href="rem_stf_e.php"> <div  class="small-box bg-green" style="width:290px;" >
                <div class="inner">
                  <h3>Email</h3>
				  <p></p>
                  <br> <br>
...
<tr>
<td> <a href="rem_stf_sms.php"> <div class="small-box bg-aqua" style="width:290px;" >
                <div class="inner">
                  <h3>SMS</h3>
				  <p></p>
                  <br> <br>
