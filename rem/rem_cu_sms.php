<?php  include '../include/header.php';?>
 <!-- /.search form -->
        ...
        <li><a href="rem_stf.php"><i class="fa fa-circle-o"></i>Staff</a></li>
                <li class="active"><a href="rem_cu.php"><i class="fa fa-circle-o"></i> Customers</a></li>
...
<li class="treeview">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Sms
            <small>Sms Reminder to all Customers</small>
          </h1>
           <ol class="breadcrumb">
            <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="rem_cu.php"><i class="fa fa-bell"></i>Customers Reminder</a></li>
            <li class="active">Customers Reminder Sms</li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-3">
              <a href="#" class="btn btn-primary btn-block margin-bottom">Sms <i class="fa fa-sms"></i></a>
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Compose Sms Reminder</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
