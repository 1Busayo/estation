      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Customers Reminder</li>
          </ol>
        </section>
            ...
            <div class="col-xs-10">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Reminder <i class="ion ion-bell" ></i></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
				 ...
				 <tr>
<td> <a href="rem_cu_e.php"> <div  class="small-box bg-green" style="width:290px;" >
                <div class="inner">
                  <h3>Email</h3>
				  <p></p>
                  <br> <br>
...
<tr>
<td> <a href="rem_cu_sms.php"> <div class="small-box bg-aqua" style="width:290px;" >
                <div class="inner">
                  <h3>SMS</h3>
				  <p></p>
                  <br> <br>
