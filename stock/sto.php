<?php  include '../include/header.php';?>
     ...
     <li class="header">MAIN NAVIGATION</li>
        ...
        <li class="active"><a href="sto.php"><i class="fa fa-circle-o"></i>Create Stock</a></li>
...
if(empty($txt1) || empty($txt2) ){
	...
	$query = mysql_query(" INSERT INTO e_stock ( `stock_name`, stock_code , stock_price) VALUES  ('{$txt1}','{$pin}','{$txt2}')") or die(mysql_error());
...
<p><span>Stock Name</span><input name="txt1" class="form-control"  data-validation="required"  type="text" style="width:200px;" required>
</p>
	


<p><span>Stock Price(For Each)</span><input  name="txt2" class="form-control"  data-validation="required"  type="text" style="width:200px;" required>
</p>

	
		<br><br>
 <input   type="submit"  class="btn btn-primary" name="submit" value="Create Stock"/>
...
$h = mysql_query("Select * FROM e_stock ") or die(mysql_error()); 
		...
		<td>&nbsp;&nbsp;&nbsp;&nbsp; <a  rel="facebox" href="sto2.php?sto_id=<?php echo $tr['stock_code']; ?>" class=" btn-sm">
          <i class="fa fa-pencil"></i> 
        </a> 
	
		</td><td>&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" id="<?php echo $tr['stock_id']; ?>" class="delbutton" title="Click To Delete"><span class="fa fa-trash"></a>
