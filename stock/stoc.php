...
if(empty($txt1) || empty($txt2)|| empty($txt3) || empty($txt4) ){
	...
	$mngs='Please fill the form completely';
	   ...
	   header("location:tan2a.php?tp=".$roxi."&msg2=".$mngs);
	      ...
	      mysql_query("Update e_tank SET tmw_open_stock ='$txt5' , date_stock='$dat' where tank_code='$roxi' ");
...
$h = mysql_query("Select * FROM e_stock  ") or die(mysql_error()); 
		...
		<td>&nbsp;&nbsp;&nbsp;&nbsp; <a  href="stock_calc.php?sto_id=<?php  echo $tr['stock_code'];?>" class=" btn-sm">
         <br> <i class="fa fa-money"></i> 
        </a> 
