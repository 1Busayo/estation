      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li><a href="view_sal.php"><i class="fa fa-users"></i>Select Customers</a></li>
            <li class="active">Select Recipt</li>
          </ol>
        </section>
...
<table id="example1" class="table table-bordered table-hover">
        ...
        <th width="7%">Date Paid</th>
        <th width="9%">Balance To Pay</th>
        
		
			<th width="11%">Recipt</th>
...
$id =$_GET['erp_id'];
			 $h = mysql_query("SELECT * FROM  cust_pay, customerdetails  WHERE cust_pay.c_id=customerdetails.c_id and cust_pay.c_id= '$id' and amount_paid !='' ORDER BY  cust_pay_id DESC ; ") or die(mysql_error()); 
        ...
        <tr class="record">
            ...
            <td><br><?php echo $tr['c_name']; ?></td>
			 ...
			 <td><br><?php $pa=$tr['date_sales'];   $daa = date('d/m/Y', strtotime($pa));  if ($daa=="01/01/1970"){ echo"";}else{ echo $daa;} ?></td>
			<td><br><?php echo $tr['sales_code']; ?></td>
            <td><br><?php echo $tr['total_amount']; ?></td>           
		   <!--<td><br><?php //echo $tr['amount_paid']; ?></td>-->
            <td><br><?php $pa2=$tr['date_paid'];   $dt2 = date('d/m/Y', strtotime($pa2));  if ($dt2=="01/01/1970"){ echo"";}else{ echo $dt2;} ?></td>
      ...
      <!--  </a><a  href="view_edit.php?erp_id=<?php echo $tr['c_id']; ?>&i_2=<?php echo $tr['sales_code']; ?>" class="btn-sm">
          <span class="glyphicon glyphicon-pencil"></span> -->
        </a> <a href="" class="delbtn" id="<?php echo $tr['sales_code']; ?>">
