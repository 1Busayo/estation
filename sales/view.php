      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">View Recipt</li>
          </ol>
        </section>
...
echo "<Center><p><h2><b>Recipt</b></h2></p></Center>"; ?>
...
<div class="right">
 <p style="text-align:left;"><b>Recipt Number:</b>  <?php echo $tron['sales_code']; ?> </p>
<p  style="text-align:left;"><b>Date Of Sales:</b> <?php $p12=$tron['date_sales'];   $da1 = date('d/m/Y', strtotime($p12)); if ($da1=="01/01/1970"){ echo"";}else{ echo $da1;}?></p>
  <p style="text-align:left;"><b>Date Of Payment:</b>  <?php $p13=$tron['date_paid'];   $da2 = date('d/m/Y', strtotime($p13)); if ($da2=="01/01/1970"){ echo"";}else{ echo $da2;}?></p>
 <!--  <p style="text-align:left;"><b>Amount Paid:</b>  <?php //echo $tron['amount_paid']; ?> </p>-->
  <p style="text-align:left;"><b>Balance To Pay:</b> <?php echo $tron['balance_to_pay']; ?> </p>
...
<table class="table table-bordered table-hover" style="text-align:center;" align="center">
    ...
    <tr>
		...
		<th style="text-align:center;" width="20%">Amount Paid</th>
        </tr>
  </thead>
 <tbody>
...
<tr>
     ...
     <td><br><?php //echo $tron['sales_code']; ?></td>
