      ...
      <li class="treeview">
			...
			<li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="../ban/ban_pre1.php"><i class="fa fa-circle-o"></i> Record Bank Transactions</a></li>
...
<li class="treeview">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Bank Reconcilation
            <small>Record Bank Transactions</small>
          </h1>
          <!--<ol class="breadcrumb">
...
if(empty($txt1)||empty($txt2)){
  ...
  //  echo"Please fill the form completely";
	...
	<br>
        ...
        <th width="5%">Record Transaction</th>
			</tr> 
        </thead>
	<tbody>
...
<?php
        ...
        <tr class="record">
          ...
          <!--  <td><br><?php //echo $tr['tricon_comment']; ?></td> --> 
			<td><br>
		&nbsp;&nbsp;&nbsp;&nbsp; <a href="ban_pre2.php?erp_id=<?php echo $tr['cb_id']; ?>" class=" btn-sm">
