...
<?php
			 $h = mysql_query("select cb_name , DATE_FORMAT(ban_dat,'%M %Y') AS period from ban_transac where cb_id='$id' group by period ") or die(mysql_error()); 
        ...
        <tr class="record">
          ...
          <!--  <td><br><?php //echo $tr['tricon_comment']; ?></td> --> 
			<td><br>
		&nbsp;&nbsp;&nbsp;&nbsp; <a href="ban_acc3.php?erp_id=<?php $id2 =$_GET['erp_id']; echo $id2; ?>&pes=<?php echo $tr['period']; ?>" class=" btn-sm">
          <span class="glyphicon glyphicon-file"></span> 
       View </a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="ban_acc_edit.php?erp_id=<?php $id2 =$_GET['erp_id']; echo $id2; ?>&pes=<?php echo $tr['period']; ?>" class=" btn-sm">
