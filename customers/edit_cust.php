...
if (!bod){
	window.location.href="view_cust.php";
...
<h1>Edit </h1>
	...
	<form action="edit_cust.php?erp_id=<?php echo $_GET['erp_id']; ?>" method="POST">


<p><span>Customers Name</span> <input type="text" name="txt1" class="form-control" type="text" data-validation="required" value='<?php echo $tr['c_name']; ?>'   style="width:200px;" data-validation-error-msg="Please Enter The Customers Name"  /></p>		

	
<p><span>Address</span> <textarea name="txt2" class="form-control" type="text"   data-validation="alphanumeric" data-validation-allowing="-,/ " data-validation-error-msg="Please Enter The Customers address"  style="width:290px;"> <?php echo $tr['c_address']; ?></textarea></p>		

<p><span>Phonumber</span> <input   name="txt3" class="form-control"  value='<?php echo $tr['c_phonenumber']; ?>'   data-validation-error-msg="Please Enter The Customers Phonumber"  data-validation="number length" data-validation-length="min11" type="text" maxlength="13"    style="width:200px;" type="text"/></p>

<p><span>Account Number(Optional)</span><input  name="txt4" value='<?php echo $tr['c_accountnumber']; ?>'  class="form-control" data-validation="number length" data-validation-length="min10"  maxlength="10" data-validation-optional="true"  data-validation-error-msg="Please Enter Your Account Number " type="text" style="width:200px;" /></p>		

<p><span>Email</span><input name="txt5" data-validation="email" class="form-control" value='<?php echo $tr['c_email']; ?>'  data-validation-error-msg="E-mail is not valid" /></p>
