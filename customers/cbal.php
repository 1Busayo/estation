	...
	<li class="treeview">
        ...
        <li><a href="add_cust.php"><i class="fa fa-circle-o"></i> Add Customers</a></li>
                ...
                <li><a href="addpay.php"><i class="fa fa-circle-o"></i> Customer Deposit</a></li>
				 <li class="active" ><a href="cbal.php"><i class="fa fa-circle-o"></i> Customer Balance</a></li>
...
<?php
			 $h = mysql_query("select * FROM customerdetails  ") or die(mysql_error()); 
        ...
        <tr class="record">
            ...
            <td><br><?php echo $tr['c_account_balance']; ?></td>           
		  
           
         
		 
		<!--	<td><br>
		&nbsp;&nbsp;&nbsp;&nbsp; <a  rel="facebox" href="addpay_two.php?erp_id=<?php echo $tr['c_id']; ?>" class=" btn-sm">
