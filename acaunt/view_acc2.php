...
<h3 class="box-title"><?php echo $tr['sheet_acct_name']; $sheet=$tr['sheet_acct_name']; ?></h3>
...
<?php
			 $h = mysql_query("select acc_tran_name , DATE_FORMAT(acc_tran_date,'%M %Y') AS period from acc_tran where acc_tran_name='$sheet' group by period ") or die(mysql_error()); 
        ...
        <tr class="record">
          ...
          <!--  <td><br><?php //echo $tr['tricon_comment']; ?></td> --> 
			<td><br>
		&nbsp;&nbsp;&nbsp;&nbsp; <a href="view_acc3.php?erp_id=<?php $id2 =$_GET['erp_id']; echo $id2; ?>&pes=<?php echo $tr['period']; ?>" class=" btn-sm">
          <span class="glyphicon glyphicon-file"></span> 
       View </a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="view_acc_edit.php?erp_id=<?php $id2 =$_GET['erp_id']; echo $id2; ?>&pes=<?php echo $tr['period']; ?>" class=" btn-sm">
