  ...
  <li class="treeview">
      ...
      <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="../acaunt/view_acc1.php"><i class="fa fa-circle-o"></i> View Account</a></li>
...
<li class="treeview">
      ...
      <div class="content-wrapper">
	   ...
	   <?php
				$a1=$_GET['erp_id'];
			 $h = mysql_query("select sheet_acct_name,grp_acct_name FROM sheet_acct where sheet_acct_id='{$a1}' ") or die(mysql_error()); 
...
<h3 class="box-title"><center><?php echo $tr['sheet_acct_name'] ;?> &nbsp;&nbsp;&nbsp;&nbsp; <?php $kk=$_GET['pes'];  echo $kk; $sheet=$tr['sheet_acct_name']; ?></center></h3>
...
$name =   $tr5['sheet_acct_name']; 
		...
		if ($type=='Debit'){
			 ...
			 $h = mysql_query("select acc_tran_name, acc_tran_mode,acc_tran_type, acc_tran_debit, acc_tran_date FROM acc_tran WHERE acc_tran_name='$sheet' AND DATE_FORMAT(acc_tran_date,'%M %Y')='$p'  ") or die(mysql_error()); 
        ...
        <tr class="record">
			...
			<td><br><?php echo $tr['acc_tran_debit']; ?></td>
		    <td><br>
...
$p2=$_GET['pes'];
	$k2 = mysql_query("SELECT sum(acc_tran_credit),sum(acc_tran_debit)  FROM acc_tran WHERE acc_tran_name='$sheet' AND DATE_FORMAT(acc_tran_date,'%M %Y')='$p2'  ") or die(mysql_error()); 
			 
			 $trk = mysql_fetch_array($k2);
			    ?>
   <?php  echo $trk['sum(acc_tran_debit)'];  ?></th>
 ...
 <?php
			 ...
			 $k = mysql_query("select acc_tran_name,acc_tran_mode, acc_tran_type, acc_tran_credit, acc_tran_date FROM acc_tran WHERE acc_tran_name='$sheet' AND DATE_FORMAT(acc_tran_date,'%M %Y')='$p'  ") or die(mysql_error()); 
		    ...
		    <td><br><?php echo $tor['acc_tran_credit']; ?></td>
		    <td><br> 
...
$p3=$_GET['pes'];
	$k3 = mysql_query("SELECT sum(acc_tran_credit) FROM acc_tran WHERE acc_tran_name='$sheet' AND DATE_FORMAT(acc_tran_date,'%M %Y')='$p3'  ") or die(mysql_error()); 
			 
			 $trk3 = mysql_fetch_array($k3);
			    ?>
   <th><?php  echo $trk3['sum(acc_tran_credit)'];?></th>
