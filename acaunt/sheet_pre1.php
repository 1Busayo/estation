  ...
  //  echo"Please fill the form completely";
	...
	<br>
        ...
        <th width="10%">Type</th>
			...
			<th width="5%">Prepare</th>
			</tr> 
        </thead>
	<tbody>

<?php
			 $h = mysql_query("select grp_acct_name ,sheet_acct_name , sheet_acct_id FROM sheet_acct ORDER BY  'sheet_acct_name' ") or die(mysql_error()); 
        ...
        <tr class="record">
          ...
          <!--  <td><br><?php //echo $tr['tricon_comment']; ?></td> --> 
			<td><br>
		&nbsp;&nbsp;&nbsp;&nbsp; <a href="sheet_pre2.php?erp_id=<?php echo $tr['sheet_acct_id']; ?>" class=" btn-sm">
