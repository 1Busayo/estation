  ...
  <li class="treeview">
      ...
      <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="../acaunt/sheet_pre1.php"><i class="fa fa-circle-o"></i> Prepare Account</a></li>
...
<h3 class="box-title"><?php echo $tr['sheet_acct_name']; ?></h3>
...
$dat = date('Y-m-d', strtotime($d)).'<br>';
 ...
 <strong><i class="fa fa-check-circle"></i>  Success!</strong>   Submitted Successfully
</div>
...
<tr>
 <td class="no">1</td>
 <td><p><input name="txt1[]" class="form-control"  data-validation="date" data-validation-help="month/day/year" data-validation-format="mm/dd/yyyy" id="datepicker"  type="text" style="width:200px;" required/></p>
</p></td>
...
<option value="Cheque">Cheque</option>
 ...
 <td><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></td>
 <td><input type="text" style="width:150px;" data-validation="number"  class="form-control amount" name="txt3[]"></td>
...
function addnewrow()
{
 ...
 var tr = '<tr>'+
 '<td class="no">'+n+'</td>'+
 '<td><input name="txt1[]" class="form-control"  title="mm/dd/yyyy e.g 09/21/2015" data-validation="date"   data-validation-format="mm/dd/yyyy" id="datep"    type="text" style="width:200px;" required/></p></td>'+
