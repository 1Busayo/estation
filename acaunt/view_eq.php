...
<?php
			 $h = mysql_query("select * FROM owners_prop ORDER BY  'own_ame' ") or die(mysql_error()); 
        ...
        <tr class="record">
            ...
            <td><br><?php echo $tr['own_name']; ?></td>
		    <td><br><a href="view_eq2.php?erp_id=<?php echo $tr['own_code']; ?>&i=1"    class="btn  btn-primary" role="button">Withdrawl</a>  &nbsp;&nbsp;&nbsp;&nbsp; <a href="view_eq2.php?erp_id=<?php echo $tr['own_code']; ?>&i=2"   class="btn btn-primary" role="button">Capital</a>   </td>
