...
<h3 class="box-title"><?php echo $tr['sheet_acct_name']; echo'&nbsp;&nbsp;&nbsp;&nbsp; '.$pe=mysql_real_escape_string($_GET['pes']);?></h3>
...
$sheet =   $tr5['sheet_acct_name']; 
	...
	?>
		...
		if ($type=='Debit'){
			 ...
			 $h = mysql_query("select acc_tran_name,acc_tran_id, acc_tran_mode, acc_tran_type, acc_tran_debit, acc_tran_date FROM acc_tran WHERE acc_tran_name='$sheet' AND DATE_FORMAT(acc_tran_date,'%M %Y')='$p'  ") or die(mysql_error()); 
...
<option value="Cheque">Cheque</option>
 ...
 <td><input type="text" style="width:150px;" class="form-control amount"  name="txt4[]" value="<?php echo $tr['acc_tran_debit']; ?>"></td>
...
<td><a href="#"  id="<?php echo $tr['acc_tran_id']; ?>" class="trash2 btn btn-danger glyphicon glyphicon-trash" role="button"></a></td>
		...
		<?php
			 ...
			 $k = mysql_query("select acc_tran_name,acc_tran_id,acc_tran_mode, acc_tran_type, acc_tran_credit, acc_tran_date FROM acc_tran WHERE acc_tran_name='$sheet' AND DATE_FORMAT(acc_tran_date,'%M %Y')='$p'  ") or die(mysql_error()); 
...
<option value="Cheque">Cheque</option>
 ...
 <td><input type="text" style="width:150px;" class="form-control amount"  name="txt4[]" value="<?php echo $tor['acc_tran_credit']; ?>"></td>
