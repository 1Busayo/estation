...
<?php
        ...
        <tr class="record">
		    ...
		    <td><br><a href="eq_nam2.php?erp_id=<?php echo $tr['own_code']; ?>&i=1"    class="btn  btn-primary" role="button">Debit</a>  &nbsp;&nbsp;&nbsp;&nbsp; <a href="eq_nam2.php?erp_id=<?php echo $tr['own_code']; ?>&i=2"   class="btn btn-primary" role="button">Credit</a>   </td>
