...
<?php
			// $h = mysql_query("select * FROM customerdetails ORDER BY  'c_name' ") or die(mysql_error()); 
			 $h = mysql_query("SELECT * FROM  cust_pay, customerdetails  WHERE cust_pay.c_id=customerdetails.c_id AND sales_code!='' GROUP BY  c_name ") or die(mysql_error()); 
        ...
        <tr class="record">
          ...
          <!--  <td><br><?php //echo $tr['tricon_comment']; ?></td> --> 
			<td><br>
		&nbsp;&nbsp;&nbsp;&nbsp; <a  rel="facebox" href="list_inv.php?erp_id=<?php echo $tr['c_id']; ?>" class=" btn-sm">
