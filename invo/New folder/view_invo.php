...
<ul class="sidebar-menu">
 ...
 <span>Sales</span> <i class="fa fa-angle-left pull-right"></i>
              ...
              <ul class="treeview-menu">
                <li><a href="../invo/crea.php"><i class="fa fa-circle-o"></i> Create Sales</a></li>
                <li><a href="../invo/view_sal.php"><i class="fa fa-circle-o"></i> View Sales</a></li>
              </ul>
            </li>
      ...
      <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="crea2.php"><i class="fa fa-circle-o"></i> View Invoice</a></li>
              </ul>
            </li>
  <li class="treeview">
              <a href="#">
...
//$d =$_GET['code'];
 ...
 $query = "SELECT sales_code FROM  cust_pay WHERE sales_code='$d'";
$query_run = mysql_query($query);
...
<tr>
	...
	<th></th>
	<th></th>
	<th><b>SUBTOTAL<input type="text" readonly style="width:150px;" class="form-control" value="<?php echo $tr2['total_amount']; ?>"></b></th>
	...
	<th></th>
	<th></th>
	<th><b>VAT(<?php echo $tr2['cust_pay_vat'].'%';?>)<input type="text" readonly style="width:150px;" class="form-control" value="<?php echo $tot = $tr2['cust_pay_vat']/100 * $tr2['total_amount']; ?>"></b></th>
...
<tr>
    ...
    <th></th>
	<th></th>
  <th>Date Of Sales<input type="text" readonly  style="width:150px;" class="form-control" value="<?php $pap = $tr2['date_sales'];   $dat2 = date('d/m/Y', strtotime($pap)); if ($dat2=="01/01/1970"){ echo"";}else{ echo $dat2;}?>"></th>
